  ...
  <div class="container">
    ...
    <div class="rwo center">
      <div class="col s12 m12 l12 xl12">
        ...
        <table class="striped">
          ...
          if (isset($_POST['btn-relatorio'])) :
            if ($marcaselecionada == "TODAS AS MARCAS") :
              $sql = "SELECT FROM estoque ORDER BY marca,modelo,fabricacao";
            else :
              $sql = "SELECT FROM estoque WHERE marca = '$marcaselecionada' ORDER BY marca,modelo,fabricacao";
            endif;
          endif;
        ...
        <br>
        <br>
        <div class="btn-large red"><a href="" onclick="window.print()">Imprimir</a></div>
      </div>
    </div>
    <br>
    <br>
